...
import random
#IMPROVMENT I add file to store highscore
file=open("highscore.txt","a+") #w+ = Write and Read --> Store a number if non exists, and check the highscore so we can compare it with our score
